interface GetObjectInfoFromS3EventRecordOutput {
  BucketName: string
  Key: string
  S3Uri: string
}
 ...
 */
export function GetObjectInfoFromS3EventRecord(
  record: any
): GetObjectInfoFromS3EventRecordOutput | undefined{
  let ret: GetObjectInfoFromS3EventRecordOutput | undefined = undefined
